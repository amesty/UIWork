...
public class C_Xinlizhangai extends BasicFragment{

	private volatile List<Counselor> XinlizhangaiList;
	private ListView XinlizhangaiLv;
	private CounselorAdapter mAdapter;
	
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
	    @Override
	    protected Void doInBackground(Void... params) {
	    	XinlizhangaiList = CounselorDao.findXinlizhangaiByTime();
	    	return null;
	    }
	    ...
	    protected void onPostExecute(Void result) {
	      ...
	      XinlizhangaiLv = (ListView) getActivity().findViewById(R.id.xinlizhangai_lv);
	      TextView empty = (TextView) getActivity().findViewById(R.id.empty_tv);
	      XinlizhangaiLv.setEmptyView(empty);
		  
	      mAdapter = new CounselorAdapter(getActivity(), XinlizhangaiList);
	     
	      XinlizhangaiLv.setAdapter(mAdapter);
	      mAdapter.notifyDataSetChanged(); 

	      if (XinlizhangaiList != null && !XinlizhangaiList.isEmpty()) {
	        empty.setVisibility(View.GONE);
	      } else {
	        empty.setVisibility(View.VISIBLE);
	      }
	      XinlizhangaiLv.setOnItemClickListener(new OnItemClickListener() {
				@Override
				public void onItemClick(AdapterView<?> listView, View itemView, int index, long id) {

					Counselor p = XinlizhangaiList.get(index);
					Bundle bundle = new Bundle();
					bundle.putSerializable("COUNSELOR", p);
					UiHelper.showFragment(C_Xinlizhangai.this, bundle, new CounselorDetailFragment());
				}			
			});
	      XinlizhangaiLv.setOnScrollListener(new OnScrollListener() {
				@Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return UiHelper.getLightThemeView(getActivity(), R.layout.fragment_c_xinlizhangai);
    }
