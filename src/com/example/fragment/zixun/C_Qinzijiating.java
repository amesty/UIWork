...
public class C_Qinzijiating extends BasicFragment{


	private volatile List<Counselor> QinzijiatingList;
	private ListView QinzijiatingLv;
	private CounselorAdapter mAdapter;
	
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
	    @Override
	    protected Void doInBackground(Void... params) {
	    	QinzijiatingList = CounselorDao.findQinzijiatingByTime();
	    	return null;
	    }
	    ...
	    protected void onPostExecute(Void result) {
	      ...
	      QinzijiatingLv = (ListView) getActivity().findViewById(R.id.qinzijiating_lv);
	      TextView empty = (TextView) getActivity().findViewById(R.id.empty_tv);
	      QinzijiatingLv.setEmptyView(empty);
		  
	      mAdapter = new CounselorAdapter(getActivity(), QinzijiatingList);
	     
	      QinzijiatingLv.setAdapter(mAdapter);
	      mAdapter.notifyDataSetChanged(); 

	      if (QinzijiatingList != null && !QinzijiatingList.isEmpty()) {
	        empty.setVisibility(View.GONE);
	      } else {
	        empty.setVisibility(View.VISIBLE);
	      }
	      QinzijiatingLv.setOnItemClickListener(new OnItemClickListener() {
				@Override
				public void onItemClick(AdapterView<?> listView, View itemView, int index, long id) {

					Counselor p = QinzijiatingList.get(index);
					Bundle bundle = new Bundle();
					bundle.putSerializable("COUNSELOR", p);
					UiHelper.showFragment(C_Qinzijiating.this, bundle, new CounselorDetailFragment());
				}			
			});
	      QinzijiatingLv.setOnScrollListener(new OnScrollListener() {
				@Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return UiHelper.getLightThemeView(getActivity(), R.layout.fragment_c_qinzijiating);
    }
