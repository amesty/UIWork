...
public class C_Qingxuguanli extends BasicFragment{

	private volatile List<Counselor> QingxuganliiList;
	private ListView QingxuganliiLv;
	private CounselorAdapter mAdapter;
	
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
	    @Override
	    protected Void doInBackground(Void... params) {
	    	QingxuganliiList = CounselorDao.findQingxuguanliByTime();
	    	return null;
	    }
	    ...
	    protected void onPostExecute(Void result) {
	      ...
	      QingxuganliiLv = (ListView) getActivity().findViewById(R.id.qingxuguanli_lv);
	      TextView empty = (TextView) getActivity().findViewById(R.id.empty_tv);
	      QingxuganliiLv.setEmptyView(empty);
		  
	      mAdapter = new CounselorAdapter(getActivity(), QingxuganliiList);
	     
	      QingxuganliiLv.setAdapter(mAdapter);
	      mAdapter.notifyDataSetChanged(); 

	      if (QingxuganliiList != null && !QingxuganliiList.isEmpty()) {
	        empty.setVisibility(View.GONE);
	      } else {
	        empty.setVisibility(View.VISIBLE);
	      }
	      QingxuganliiLv.setOnItemClickListener(new OnItemClickListener() {
				@Override
				public void onItemClick(AdapterView<?> listView, View itemView, int index, long id) {

					Counselor p = QingxuganliiList.get(index);
					Bundle bundle = new Bundle();
					bundle.putSerializable("COUNSELOR", p);
					UiHelper.showFragment(C_Qingxuguanli.this, bundle, new CounselorDetailFragment());
				}			
			});
	      QingxuganliiLv.setOnScrollListener(new OnScrollListener() {
				@Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return UiHelper.getLightThemeView(getActivity(), R.layout.fragment_c_qingxuguanli);
    }
