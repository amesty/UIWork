...
public class C_Ziwochengzhang extends BasicFragment{

	private volatile List<Counselor> ZiwochengzhangList;
	private ListView ZiwochengzhangLv;
	private CounselorAdapter mAdapter;
	
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
	    @Override
	    protected Void doInBackground(Void... params) {
	    	ZiwochengzhangList = CounselorDao.findZiwochengzhangByTime();
	    	return null;
	    }
	    ...
	    protected void onPostExecute(Void result) {
	      ...
	      ZiwochengzhangLv = (ListView) getActivity().findViewById(R.id.ziwochengzhang_lv);
	      TextView empty = (TextView) getActivity().findViewById(R.id.empty_tv);
	      ZiwochengzhangLv.setEmptyView(empty);
		  
	      mAdapter = new CounselorAdapter(getActivity(), ZiwochengzhangList);
	     
	      ZiwochengzhangLv.setAdapter(mAdapter);
	      mAdapter.notifyDataSetChanged(); 

	      if (ZiwochengzhangList != null && !ZiwochengzhangList.isEmpty()) {
	        empty.setVisibility(View.GONE);
	      } else {
	        empty.setVisibility(View.VISIBLE);
	      }
	      ZiwochengzhangLv.setOnItemClickListener(new OnItemClickListener() {
				@Override
				public void onItemClick(AdapterView<?> listView, View itemView, int index, long id) {

					Counselor p = ZiwochengzhangList.get(index);
					Bundle bundle = new Bundle();
					bundle.putSerializable("COUNSELOR", p);
					UiHelper.showFragment(C_Ziwochengzhang.this, bundle, new CounselorDetailFragment());
				}			
			});
	      ZiwochengzhangLv.setOnScrollListener(new OnScrollListener() {
				@Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return UiHelper.getLightThemeView(getActivity(), R.layout.fragment_c_ziwochengzhang);
    }
