...
public class Q_hotFragment extends BasicFragment {
	
	public volatile List<Problem> hotProblemList;
	private ListView hotProblemLv;
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
	    ...
	    protected Void doInBackground(Void... params) {
	    	hotProblemList = QuestionDao.findQuestionsByHot();
	    	return null;
	    }
	    ...
	    protected void onPostExecute(Void result) {
	      ...
	      hotProblemLv = (ListView) getActivity().findViewById(R.id.hot_question_lv);
	      TextView empty = (TextView) getActivity().findViewById(R.id.hot_empty_tv);
	      hotProblemLv.setEmptyView(empty);
		  mAdapter = new ProblemAdapter(getActivity(), hotProblemList);
	     
		  hotProblemLv.setAdapter(mAdapter);

	      if (hotProblemList != null && !hotProblemList.isEmpty()) {
	        empty.setVisibility(View.GONE);
	      } else {
	        empty.setVisibility(View.VISIBLE);
	      }
	      hotProblemLv.setOnItemClickListener(new OnItemClickListener() {
				@Override
				public void onItemClick(AdapterView<?> listView, View itemView, int index, long id) {

					Problem p = hotProblemList.get(index);
					final Bundle bundle = new Bundle();
					bundle.putSerializable("PROBLEM", p);
					UiHelper.showFragment(Q_hotFragment.this, bundle, new QuestionDetailFragment());
				}			
			});
	      hotProblemLv.setOnScrollListener(new OnScrollListener() {
				@Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return UiHelper.getLightThemeView(getActivity(), R.layout.fragment_w_hot);
    }
