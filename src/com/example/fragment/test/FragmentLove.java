...
public class FragmentLove extends BasicFragment{
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
	    ...
	    protected Void doInBackground(Void... params) {
	    	try {
	    		newTestList = (new TestDao()).findTestByType("love");
			} catch (AVException e) {
				e.printStackTrace();
			}
	    	return null;
	    ...
	    protected void onPostExecute(Void result) {
	      ...
	      newTestLv = (ListView) getActivity().findViewById(R.id.test_love_lv);
	      TextView noNetwork = (TextView) getActivity().findViewById(R.id.test_love_empty_tv);
	      ...
	      newTestLv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> listView, View itemView, int index, long id) {
					...
					UiHelper.showFragment(FragmentLove.this, bundle, new TestDetailFragment());
				}			
			});
			*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return UiHelper.getLightThemeView(getActivity(), R.layout.fragment_test_love);
    }
