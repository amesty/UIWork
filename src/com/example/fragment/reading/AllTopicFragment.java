...
public class AllTopicFragment extends BasicFragment{
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
	    ...
	    protected Void doInBackground(Void... params) {
	    	try {
	    		newArticleList = (new ArticleDao()).findArticleByType("all");
			} catch (AVException e) {
				e.printStackTrace();
			}
	    	return null;
	    ...
	    protected void onPostExecute(Void result) {
	      ...
	      mArticleLv = (ListView) getActivity().findViewById(R.id.reading_listview_all);
	      TextView noNetwork = (TextView) getActivity().findViewById(R.id.reading_all_empty_tv);
	      ...
	      mArticleLv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> listView, View itemView, int index, long id) {
					...
					UiHelper.showFragment(AllTopicFragment.this, bundle, new ArticleDetailFragment());
				}			
			});
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return UiHelper.getLightThemeView(getActivity(), R.layout.fragment_reading_listview_all);
    }
