...
public class DateHelper {
    ...
    private final static SimpleDateFormat  DF_DATETIME = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
    private final static SimpleDateFormat  DF_DATE = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    public static long convertTextToDate(String text) {
        return convertTextToDate(text, DF_DATE);
    }
    ...
    public static long getStartOfThisWeek(){
        ...
        c.add(Calendar.DAY_OF_YEAR, -(week-2));
        return getZeroHourOfDay(c);
    }
    
    public static long getYearBeforeNow(int yearsBefore){
        Calendar c = Calendar.getInstance();
        int year = c.get(Calendar.YEAR) - yearsBefore;
        c.set(Calendar.YEAR, year);
    	return c.getTimeInMillis();
    }

    public static int getAgeByBirthday(int birthdayYear){
        Calendar c = Calendar.getInstance();
    	return c.get(Calendar.YEAR) - birthdayYear;
    }
